...
<%!JobDAO dao = new JobDAO();
    ...
    Dataset<Row> jobDB = ex.sendJobDB();
            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                        ...
                        <li><a href="summary" class="active">Data Summary</a></li>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12" data-scroll-reveal="enter bottom move 50px over 0.6s after 0.2s">
                <div class="pricing-item">
                    <div class="pricing-header">
                        <h3 class="pricing-title">The Structure and summary of the data </h3>
                    </div>
                    <div class="pricing-body">

                            <pre>
							<p class="left-text">
							<%=dao.viewDescribe(jobDB) %>
							</p>
							</pre>
                    </div>

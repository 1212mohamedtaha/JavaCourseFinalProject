...
<%!JobDAO dao = new JobDAO();
    ...
    Dataset<Row> newDF = dao.factorizeCol(cleanDF);
            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                        ...
                        <li><a href="factorization" class="active">Factorization</a></li>
                    </ul>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="center-heading">
                    <h2 class="section-title">Factorization</h2>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12" data-scroll-reveal="enter bottom move 50px over 0.6s after 0.2s">
                <div class="pricing-item">
                    <div class="pricing-header">
                        <h3 class="pricing-title">The data summary after factorizing the YearsExp feature </h3>
                    </div>
                    <div class="pricing-body">

                            <pre>
							<p>
							<%=dao.viewDescribe(newDF) %>
							</p>
							</pre>
                    </div>
...
<footer >
    ...
    <div class="row">
        <div class="col-lg-12">
            <p class="copyright">ITI AI-Pro Intake 1 | Mansoura Group 2 </p>
        </div>
    </div>

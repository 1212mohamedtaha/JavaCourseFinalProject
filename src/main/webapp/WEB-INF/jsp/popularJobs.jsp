...
<%!
    ...
    Dataset<Row> popularJobTitles = dao.popularJobTitle(cleanDF);

    Map<String, Long> mapPopularJobTitle = dao.mapPopularJobTitle(popularJobTitles);

    String titleBar = "TheMostPopularJobTitlesBarChart.jpg";
    String titlePie = "TheMostPopularJobTitlesPieChart.jpg";


%>
<%  dao.graphPieChart(mapPopularJobTitle,titlePie);
    dao.graphBarChart(mapPopularJobTitle,titleBar, "Title","jobs count");%>
<!-- ***** Preloader Start ***** -->
<div id="preloader">
    <div class="jumper">
        <div></div>
            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                        ...
                        <li><a href="popular-jobs" class="active">Most popular job titles</a></li>
                        <li><a href="popular-areas">Most popular job locations</a></li>
                        <li><a href="important-skills">Most Important Skills</a></li>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="center-heading">
                    <h2 class="section-title">Most popular job titles</h2>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12" data-scroll-reveal="enter bottom move 50px over 0.6s after 0.2s">
                <div class="pricing-item">
                    <div class="pricing-header">
                        <h3 class="pricing-title">The Most popular job titles in the dataset</h3>
                    </div>
                    <div class="pricing-body">

                            <pre class="left-text">
							<p>
                                <%=dao.viewPopularJobTitle(popularJobTitles) %>
							</p>
							</pre>
                    </div>

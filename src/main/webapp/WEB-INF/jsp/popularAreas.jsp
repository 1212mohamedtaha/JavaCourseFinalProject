...
<%!
    ...
    Dataset<Row> popularAreas = dao.popularAreas(cleanDF);

    Map<String, Long> mapPopularAreas = dao.mapPopularAreas(popularAreas);

    String titleBar = "TheMostPopularAreasBarChart.jpg";
    String titlePie = "TheMostPopularAreasPieChart.jpg";



%>
<% dao.graphPieChart(mapPopularAreas,titlePie);
    dao.graphBarChart(mapPopularAreas,titleBar, "companies","jobs count");%>
            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                        ...
                        <li><a href="popular-areas" class="active">Most popular job locations</a></li>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="center-heading">
                    <h2 class="section-title">Most popular job areas</h2>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12" data-scroll-reveal="enter bottom move 50px over 0.6s after 0.2s">
                <div class="pricing-item">
                    <div class="pricing-header">
                        <h3 class="pricing-title">Most popular areas for jobs</h3>
                    </div>
                    <div class="pricing-body">

                            <pre class="left-text">
							<p>
                                <%= dao.viewPopularAreas(popularAreas) %>
							</p>
							</pre>
                    </div>

...
<%!
    ...
    Map<String, Long> mapDemandingCompanies = dao.mapDemandingCompanies(demandingCompanies);

    String titleBar = "TheMostDemandingCompaniesForJobsBarChart.jpg";
    String titlePie = "TheMostDemandingCompaniesForJobsPieChart.jpg";


%>
<%  dao.graphPieChart(mapDemandingCompanies,titlePie);
    dao.graphBarChart(mapDemandingCompanies,titleBar, "companies","jobs count");%>
<!-- ***** Preloader Start ***** -->
<div id="preloader">
    <div class="jumper">
        <div></div>
            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                        ...
                        <li><a href="jop-per-company" class="active">Number of jobs per company</a></li>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="center-heading">
                    <h2 class="section-title">Jobs demanded per company </h2>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12" data-scroll-reveal="enter bottom move 50px over 0.6s after 0.2s">
                <div class="pricing-item">
                    <div class="pricing-header">
                        <h3 class="pricing-title">The number of jobs demanded by each company </h3>
                    </div>
                    <div class="pricing-body">

                            <pre class="left-text">
							<p>
                                <%=    dao.viewDemandingCompanies(demandingCompanies) %>
